...
public class MessageRepository(DateAppDbContext context, IMapper mapper) : IMessageRepository
{
    ...
    public async Task<Message?> GetMessage(int id) { return await context.Messages.FindAsync(id); }
    ...
    public async Task<PagedList<MessageDto>> GetMessagesForUser(MessageParams messageParams)
    {
        ...
        query = messageParams.Container switch
        {
            ...
            _ => query.Where(
                x => x.Recipient.UserName == messageParams.Username && x.DateRead == null && x.RecipientDeleted == false)
        };
