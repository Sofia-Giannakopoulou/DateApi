...
public class UserRepository(DateAppDbContext context, IMapper mapper) : IUserRepository
{
    ...
    public async Task<AppUser?> GetUserByIdAsync(int id) { return await context.Users.FindAsync(id); }
